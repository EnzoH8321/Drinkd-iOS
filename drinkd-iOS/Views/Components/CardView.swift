...
struct CardView: View {
    ...
    init(cardCounter: Binding<Int> ,in restaurantDetails: YelpApiBusinessSearchProperties, forView viewModel: drinkdViewModel) {
